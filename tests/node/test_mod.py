...
if __name__ == '__main__':
    Mod.export_mod_broadcast()
    Mod.export_mod_int64_fmod()
    Mod.export_mod_mixed_sign_float16()
    Mod.export_mod_mixed_sign_float32()
    Mod.export_mod_mixed_sign_float64()
    Mod.export_mod_mixed_sign_int16()
    Mod.export_mod_mixed_sign_int32()
    Mod.export_mod_mixed_sign_int64()
    Mod.export_mod_mixed_sign_int8()
    Mod.export_mod_uint16()
    Mod.export_mod_uint32()
    Mod.export_mod_uint64()
    Mod.export_mod_uint8()
