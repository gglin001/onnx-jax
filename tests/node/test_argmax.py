...
if __name__ == '__main__':
    ArgMax.export_no_keepdims()
    ArgMax.export_keepdims()
    ArgMax.export_default_axes_keepdims()
    ArgMax.export_negative_axis_keepdims()
    ArgMax.export_no_keepdims_select_last_index()
    ArgMax.export_keepdims_select_last_index()
    ArgMax.export_default_axes_keepdims_select_last_index()
    ArgMax.export_negative_axis_keepdims_select_last_index()
