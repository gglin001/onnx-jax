...
if __name__ == '__main__':
    ReduceLogSumExp.export_default_axes_keepdims()
    ReduceLogSumExp.export_do_not_keepdims()
    ReduceLogSumExp.export_keepdims()
    ReduceLogSumExp.export_negative_axes_keepdims()
