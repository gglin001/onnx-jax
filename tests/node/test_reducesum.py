...
if __name__ == '__main__':
    ReduceSum.export_default_axes_keepdims()
    ReduceSum.export_do_not_keepdims()
    ReduceSum.export_keepdims()
    ReduceSum.export_negative_axes_keepdims()
    ReduceSum.export_empty_axes_input_noop()
