...
if __name__ == '__main__':
    ...
    MaxPool.export_maxpool_2d_dilations()
    MaxPool.export_maxpool_2d_pads()
    MaxPool.export_maxpool_2d_precomputed_pads()
    MaxPool.export_maxpool_2d_precomputed_same_upper()
    MaxPool.export_maxpool_2d_precomputed_strides()
    # MaxPool.export_maxpool_2d_same_lower()
    MaxPool.export_maxpool_2d_same_upper()
    MaxPool.export_maxpool_2d_strides()
    MaxPool.export_maxpool_2d_uint8()
    MaxPool.export_maxpool_3d_default()
    # MaxPool.export_maxpool_with_argmax_2d_precomputed_pads()
    # MaxPool.export_maxpool_with_argmax_2d_precomputed_strides()
