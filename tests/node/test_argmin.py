...
if __name__ == '__main__':
    ArgMin.export_no_keepdims()
    ArgMin.export_keepdims()
    ArgMin.export_default_axes_keepdims()
    ArgMin.export_negative_axis_keepdims()
    ArgMin.export_no_keepdims_select_last_index()
    ArgMin.export_keepdims_select_last_index()
    ArgMin.export_default_axes_keepdims_select_last_index()
    ArgMin.export_negative_axis_keepdims_select_last_index()
