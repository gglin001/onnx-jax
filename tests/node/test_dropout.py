...
if __name__ == '__main__':
    # import inspect
    # for func in inspect.getmembers(Dropout, predicate=inspect.isfunction):
    #     print(f"Dropout.{func[0]}()")
    Dropout.export_default()
    Dropout.export_default_mask()
    Dropout.export_default_mask_ratio()
    Dropout.export_default_old()
    Dropout.export_default_ratio()
    # Dropout.export_random_old()
    # Dropout.export_training()
    # Dropout.export_training_default()
    # Dropout.export_training_default_ratio_mask()
    # Dropout.export_training_default_zero_ratio()
    # Dropout.export_training_default_zero_ratio_mask()
    # Dropout.export_training_ratio_mask()
